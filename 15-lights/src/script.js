...
// rectAreaLightHelper is not THREE variable
...
gui.add(directionLight, 'intensity').min(0).max(1).step(0.01).name('Direction Light')
gui.add(directionLight, 'intensity').min(0).max(1).step(0.01).name('HemiSphere Light')
gui.add(pointLight, 'intensity').min(0).max(1).step(0.01).name('Point Light')
gui.add(spotLight, 'intensity').min(0).max(1).step(0.01).name('Spot Light')
