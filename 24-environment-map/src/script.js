...
gui.add(scene, 'backgroundBlurriness').min(0).max(10).step(0.01)
...
gui.add(scene.backgroundRotation, 'y').min(0).max(Math.PI*2).step(0.01).name('BakcgroundRotationY')
